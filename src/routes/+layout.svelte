...
<nav class="bg-[#384B52] h-12 text-white flex justify-between items-center">
	<div class="flex justify-between items-center w-screen max-w-4xl mx-auto px-6">
...
<div class="bg-[#3F565E] h-[120px] flex justify-between items-center">
	<div class="flex items-center w-screen max-w-4xl mx-auto px-6">
