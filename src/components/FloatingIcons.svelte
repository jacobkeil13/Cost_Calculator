...
{#if clientX > 960}
	<div class="absolute flex flex-col -left-[15px] top-[114px] space-y-[8px]">
		<div
			...
			class:other={step !== 0}
		>
			<box-icon type="solid" name="info-circle" />
		</div>
		<div
			class="flex justify-center items-center w-8 h-8 bg-white rounded-full"
			class:active={step === 1}
			class:other={step !== 1}
		>
			<box-icon name="dollar-circle" type="solid" />
		</div>
		<div
			class="flex justify-center items-center w-8 h-8 bg-white rounded-full"
			class:active={step === 2}
			class:other={step !== 2}
		>
			<box-icon name="home-alt-2" type="solid" />
		</div>
		<div
			class="flex justify-center items-center w-8 h-8 bg-white rounded-full"
			class:active={step === 2}
			class:other={step !== 2}
		>
			<box-icon name="bowl-hot" type="solid" />
		</div>
		<div
			class="flex justify-center items-center w-8 h-8 bg-white rounded-full"
			class:active={step === 3}
		...
		<div
			...
			class:other={step !== 6}
		>
			<box-icon name="wallet" type="solid" />
		</div>
		<div
			class="flex justify-center items-center w-8 h-8 bg-white rounded-full"
			class:active={step === 7}
